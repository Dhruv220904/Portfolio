...
const statements = [
  "I am a Product-focused CS undergraduate with hands-on AI and full-stack execution.",
  "I convert user research into PRDs, user stories, and execution-ready product flows.",
  "I plan roadmaps using impact-effort, metrics, and stakeholder alignment.",
  "I understand and build real solutions with my technical skills and product knowledge.",
  "I translate model outputs into practical retention and decision insights.",
]
    ...
    <section id="about" ref={containerRef} className="relative py-32 overflow-hidden md:py-0">
      ...
      >
        ...
        <h2 className="font-sans text-3xl md:text-5xl font-light italic">
          <span className="text-mint">Product</span> + AI Builder
        </h2>
      </motion.div>
        ...
        <motion.div style={{ x: smoothX }} className="flex gap-16 md:gap-24 px-8 md:px-12 whitespace-nowrap">
          {statements.map((statement, index) => (
            <motion.p
              ...
              style={{
                WebkitTextStroke: index % 2 === 0 ? "none" : "1px color-mix(in srgb, var(--palette-paper) 35%, transparent)",
